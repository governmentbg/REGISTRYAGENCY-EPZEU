...
{
    [XmlRoot(ElementName = "A15", Namespace = Namespaces.ApplicationsNamespace)]
	public class A15 : ApplicationFormABase<A15Fields>
    {
        public override ApplicationFormTypes AppType
        {
            get { return ApplicationFormTypes.A15; }
        }
    }

    
    [XmlType(TypeName = "A15Fields", Namespace = Namespaces.FieldsNamespace)]
	public class A15Fields : ApplicationFormAFieldsBase
    {
        #region Fields
        ...
        public F017b_TemporarilySuspendedStatusForPublicBenefits TemporarilySuspendedStatusForPublicBenefits { get; set; }
