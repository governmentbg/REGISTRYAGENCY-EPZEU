...
{
    [XmlType(TypeName = "DateOfRenewingDistraint", Namespace = EPZEU.CR.Domain.Common.Namespaces.FieldsNamespace)]
    [XmlRoot(ElementName = "DateOfRenewingDistraint", Namespace = EPZEU.CR.Domain.Common.Namespaces.FieldsNamespace)]
    public partial class F326_DateOfRenewingDistraint : TextRecordField
    {
        [XmlIgnore]
        ...
        public const string FieldIdentCode = "03260";
