...
{
    public class LiquidationEntrySearchCriteriaValidator : CRBasePagedSearchCriteriaValidator<LiquidationEntrySearchCriteria>
    {
        public LiquidationEntrySearchCriteriaValidator(IOptionsMonitor<GlobalOptions> globalOptionsAccessor) : base(globalOptionsAccessor)
        {
        }

        public override ValidationResult Validate(ValidationContext<LiquidationEntrySearchCriteria> context)
        {
