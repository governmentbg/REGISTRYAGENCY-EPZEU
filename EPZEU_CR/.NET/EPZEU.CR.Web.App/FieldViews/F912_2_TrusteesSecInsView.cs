...
{
    public class F912_2_TrusteesSecInsView : FieldViewBase<F912_2_TrusteesSecIns>
    {
        protected override void HtmlDisplayInternal(TextWriter writer, F912_2_TrusteesSecIns field)
        {
            WrapRecordListForDisplay(writer, field.TrusteeSecInsList, (w, r) =>
            {
