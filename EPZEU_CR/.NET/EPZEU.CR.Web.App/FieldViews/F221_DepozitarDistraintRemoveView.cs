...
{
    public class F221_DepozitarDistraintRemoveView : FieldViewBase<F221_DepozitarDistraintRemove>
    {
        protected override void HtmlDisplayInternal(TextWriter writer, F221_DepozitarDistraintRemove field)
        {
            if (!string.IsNullOrEmpty(field.Court))
            {
                ...
                if (!string.IsNullOrEmpty(field.CaseNo))
                    writer.Write("<br/>");
            }
            ...
            if (!string.IsNullOrEmpty(field.CaseNo))
            {
                ...
                writer.Write(": ");
                writer.Write(HttpUtility.HtmlEncode(field.CaseNo));
            }
        }
    }
}