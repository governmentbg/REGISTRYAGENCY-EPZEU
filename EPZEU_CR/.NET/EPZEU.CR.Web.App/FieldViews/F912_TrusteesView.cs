...
{
    public class F912_TrusteesView : FieldViewBase<F912_Trustees>
    {
        protected override void HtmlDisplayInternal(TextWriter writer, F912_Trustees field)
        {
            WrapRecordListForDisplay(writer, field.TrusteeList, (w, r) =>
            {
                ...
                {
                    w.Write("<br/>");
                    w.Write(LocalizeLabel("CR_APP_SYNDIC_TYPE_L"));
                    w.Write(": ");
