...
{
    public class F915_3_SupervisionBodyFullThirdInsView : FieldViewBase<F915_3_SupervisionBodyFullThirdIns>
    {
        protected override void HtmlDisplayInternal(TextWriter writer, F915_3_SupervisionBodyFullThirdIns field)
        {
            WrapRecordListForDisplay(writer, field.SupervisionBodyMemberFullThirdInsList, (w, r) =>
            {
