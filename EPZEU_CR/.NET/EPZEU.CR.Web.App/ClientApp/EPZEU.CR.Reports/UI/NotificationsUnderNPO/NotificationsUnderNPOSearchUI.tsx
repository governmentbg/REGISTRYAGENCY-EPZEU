...
interface NotificationsUnderNPOSearchUIProps extends BaseProps {
    onSearchCallback: () => void;
}

const valSummaryPropNames = ["", "LiquidationSearchCriteria."];

@observer export class NotificationsUnderNPOSearchUI extends EPZEUBaseComponent<NotificationsUnderNPOSearchUIProps, NotificationsUnderNPOSearchCriteria> {
    private searchButton: HTMLButtonElement = null;
    private cmpUniqueId: string;


    constructor(props: NotificationsUnderNPOSearchUIProps) {
        super(props)
                    ...
                    <div className="card card--search card--collapsible">
                        ...
                        <div id={`collapsable-content-${this.cmpUniqueId}`} className="collapse" style={{ display: 'block' }}>
                            <div className="card-body">
                                ...
                                <Period
                                    modelReferenceOfFirstDate={new BindableReference(this.model, 'entryDateFrom', this.props.modelReference.getValidators())}
                                    modelReferenceOfSecondDate={new BindableReference(this.model, 'entryDateTo', this.props.modelReference.getValidators())} />
                                <div className="row">
    ...
    @action onClear(): void {
        this.model.entryDateFrom = undefined;
        this.model.entryDateTo = undefined;
