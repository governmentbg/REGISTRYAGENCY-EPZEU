...
import { V26 } from '../ApplicationFormsV';
import { V26Fields } from '../ModelsAutoGenerated';
import { ApplicationFormVValidator } from './ApplicationFormVValidator';

export class V26Validator extends ApplicationFormVValidator<V26> {
    ...
    constructor() {
        ...
        this.ruleFor(m => m.fields).setValidator(new V26FieldsValidator());
    }

    public validate(obj: V26): boolean {
    ...
    private validateAdditionalApps(mainApp: V26): boolean {
        let isValid = true;
    ...
    private validateAllUICsAreRegisteredInTR(mainApp: V26): boolean {
        let isValid = true;
...
export class V26FieldsValidator extends ApplicationFormFieldsBaseValidator<V26Fields>{
    ...
    public validate(obj: V26Fields): boolean {
