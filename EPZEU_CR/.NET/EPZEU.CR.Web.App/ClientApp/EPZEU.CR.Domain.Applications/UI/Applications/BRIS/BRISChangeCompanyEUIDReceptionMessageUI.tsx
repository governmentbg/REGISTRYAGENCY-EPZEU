...
interface BRISChangeCompanyEUIDReceptionMessageUIProps extends BaseProps, ApplicationFormContextProviderProps {
}

class BRISChangeCompanyEUIDReceptionMessageUIImpl extends EPZEUBaseComponent<BRISChangeCompanyEUIDReceptionMessageUIProps, BRISChangeCompanyEUIDReceptionMessage> {
...
export const BRISChangeCompanyEUIDReceptionMessageUI = withApplicationFormContext(BRISChangeCompanyEUIDReceptionMessageUIImpl);