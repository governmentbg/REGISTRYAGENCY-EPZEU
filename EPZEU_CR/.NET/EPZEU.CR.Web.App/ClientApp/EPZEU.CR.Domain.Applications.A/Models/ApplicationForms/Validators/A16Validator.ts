...
import { A16 } from '../../ApplicationForms/ApplicationFormsA';
...
import { A16Fields } from '../ModelsAutoGenerated';
import { ApplicationFormAFieldsBaseValidator, ApplicationFormAValidator } from './ApplicationFormAValidator';

export class A16Validator extends ApplicationFormAValidator<A16> {
    constructor() {
        super();

        this.ruleFor(m => m.fields).setValidator(new A16FieldsValidator());
    }

    public validate(obj: A16): boolean {
...
export class A16FieldsValidator extends ApplicationFormAFieldsBaseValidator<A16Fields>{
    constructor() {
        super();
    ...
    public validate(obj: A16Fields): boolean {
        let isValid = super.validate(obj);
