...
export class {1} extends {2} {{ {3}
    ...
    {
        if(property.Type.BaseClass != null && property.Type.Name!="F002_Company" && property.Type.Name !="F004_Transliteration" && property.Type.Name!="F003_LegalForm" && property.Type.Name != "F0223_EuropeanEconomicInterestGrouping")
        {
...
$Classes(c=>(c.Namespace == "EPZEU.CR.Domain.ApplicationForms" && 
                (c.Name == "ApplicationFormAFieldsBase" ||                
                 c.Name == "A4Fields" ||
                 c.Name == "A1Fields" ||
                 c.Name == "A2Fields" ||
                 c.Name == "A3Fields" ||
