...
interface A15UIProps extends BaseProps, ApplicationFormContextProviderProps {
}

const fieldInfoKeysF002 = ['CR_APP_00005_I'];
const fieldInfoKeysF004 = ['CR_APP_00191_I'];
const fieldInfoKeysF005 = ['CR_APP_00038_I', 'CR_APP_00032_I'];
const fieldInfoKeysF006b = ['CR_APP_00181_I'];
const fieldInfoKeysF006g = ['CR_APP_00182_I'];
const fieldInfoKeysF006a = ['CR_APP_00183_I'];
const fieldInfoKeysF0103 = ['CR_APP_REPRESENTATIVES_ASSOCIATION_I'];
const fieldInfoKeysF011 = ['CR_APP_00230_I'];
const fieldInfoKeysF012g = ['CR_APP_00170_I'];
const fieldInfoKeysF012d = ['CR_APP_00171_I', 'CR_APP_00172_I'];
const fieldInfoKeysF017 = ['CR_APP_00173_I'];
const fieldInfoKeysF025b = ['CR_APP_00175_I'];
const fieldInfoKeysF027 = ['CR_APP_00176_I'];
const infoTextKeys1 = ['CR_APP_00027_I', 'CR_APP_00029_I', 'CR_APP_00129_I'];
const infoTextKeys2 = ['CR_APP_00129_I'];
const infoTextKeys3 = ['CR_APP_00174_I'];
const designatedToPerformPublicBenefitPropname = ['designatedToPerformPublicBenefit'];

class A15UIImpl extends EPZEUBaseComponent<A15UIProps, A15> {

    renderEdit(): JSX.Element {
        return (<>
            <ApplicationTitleUI appType={ApplicationFormTypes.A15} />
...
export const A15UI = withApplicationFormContext(A15UIImpl);