...
import { F021_LimitedLiabilityPartnersUIFieldUI } from '../Fields/F021_LimitedLiabilityPartnersUI';
import { F027_AddemptionOfTraderFieldUI } from '../Fields/F027_AddemptionOfTraderUI';

interface A3UIProps extends BaseProps, ApplicationFormContextProviderProps {
}
...
const fieldInfoKeysF021 = ['CR_APP_00119_I'];
...
class A3UIImpl extends EPZEUBaseComponent<A3UIProps, A3> {

    renderEdit(): JSX.Element {

        return (<>
            <ApplicationTitleUI appType={ApplicationFormTypes.A3} />
            ...
            <F021_LimitedLiabilityPartnersUIFieldUI fieldInfoKeys={fieldInfoKeysF021} {...this.bind(m => m.fields.limitedLiabilityPartners)} />
    ...
    renderDisplay(): JSX.Element {
        return (<>
            ...
            <F021_LimitedLiabilityPartnersUIFieldUI {...this.bind(m => m.fields.limitedLiabilityPartners)} />
...
export const A3UI = withApplicationFormContext(A3UIImpl);