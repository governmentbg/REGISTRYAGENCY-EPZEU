...
import { BankruptcySearchCriteria } from '../EntriesSearchCriteria';
import { isMoment } from 'moment';


export class BankruptcySearchCriteriaValidator extends EPZEUBaseValidator<BankruptcySearchCriteria, any> {
    constructor() {
        super();
    ...
    public validate(obj: BankruptcySearchCriteria): boolean {
