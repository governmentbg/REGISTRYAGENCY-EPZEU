...
interface DocumentDraftAccessUIProps extends BaseRouteProps<any>, AsyncUIProps, BaseRoutePropsExt, IDataServiceProviderProps {
    guid: string;
}

@observer class DocumentDraftAccessUIImpl extends EPZEUBaseComponent<DocumentDraftAccessUIProps, any> {
    ...
    constructor(props: DocumentDraftAccessUIProps) {
        super(props);
    ...
    public downloadDocument(guid: string): Promise<boolean> {
        return documentsDataService.getDraftDownloadUrl(guid).then(downloadUrl => {
...
export const DocumentDraftAccessUI = withRouter(withDataServiceProvider(withAsyncFrame(DocumentDraftAccessUIImpl)));