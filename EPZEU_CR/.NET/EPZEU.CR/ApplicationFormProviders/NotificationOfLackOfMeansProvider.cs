...
{
    /// <summary>
    /// Реализация на интерфейс IApplicationProvider за работа със "Уведомление за липса на средства".
    /// </summary>
    internal class NotificationOfLackOfMeansProvider : AppointingDemandDocumentsProvider<NotificationOfLackOfMeans>
    {
