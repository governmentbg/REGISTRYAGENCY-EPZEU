...
{
    /// <summary>
    /// Реализация на интерфейс IApplicationProvider за работа със съдържанието на "Удостоверение за вписвания за определен период (извлечение)"
    /// </summary>
    internal class RequestForEntryByPeriodCertificateProvider : ApplicationFormProviderBase<RequestForEntryByPeriodCertificate>
    {
