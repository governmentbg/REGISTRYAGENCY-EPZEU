...
{
    /// <summary>
    /// Реализация на интерфейс IApplicationWithFieldsProvider за работа със съдържанието на заявление "В23 Заявление за спиране на вписването при оспорване на преобразуването"
    /// </summary>
    internal class V23Provider : ApplicationFormVProviderBase<V23>
    {
