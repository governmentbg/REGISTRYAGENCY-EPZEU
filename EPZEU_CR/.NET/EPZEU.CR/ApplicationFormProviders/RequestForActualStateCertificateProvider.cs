...
{
    /// <summary>
    /// Реализация на интерфейс IApplicationProvider за работа със съдържанието на "Удостоверение за актуално състояние"
    /// </summary>
    internal class RequestForActualStateCertificateProvider : ApplicationFormProviderBase<RequestForActualStateCertificate>
    {
