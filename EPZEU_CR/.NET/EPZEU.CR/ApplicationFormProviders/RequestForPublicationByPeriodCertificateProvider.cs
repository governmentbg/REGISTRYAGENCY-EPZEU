...
{
    /// <summary>
    /// Реализация на интерфейс IApplicationProvider за работа със съдържанието на "Удостоверение за обявявания за определен период (извлечение)"
    /// </summary>
    internal class RequestForPublicationByPeriodCertificateProvider : ApplicationFormProviderBase<RequestForPublicationByPeriodCertificate>
    {
