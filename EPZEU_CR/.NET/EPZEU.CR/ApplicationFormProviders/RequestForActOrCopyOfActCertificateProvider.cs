...
{
    /// <summary>
    /// Реализация на интерфейс IApplicationProvider за работа със съдържанието на "Удостоверение за обявяване или копие от обявен акт"
    /// </summary>
    internal class RequestForActOrCopyOfActCertificateProvider : ApplicationFormProviderBase<RequestForActOrCopyOfActCertificate>
    {
