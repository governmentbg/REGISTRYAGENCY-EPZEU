...
{
    /// <summary>
    /// Реализация на интерфейс IApplicationProvider за работа със съдържанието на "Удостоверение за липса на вписано обстоятелство или обявен акт в търговския регистър"
    /// </summary>
    internal class RequestForMissingActsCertificateProvider : ApplicationFormProviderBase<RequestForMissingActsCertificate>
    {
