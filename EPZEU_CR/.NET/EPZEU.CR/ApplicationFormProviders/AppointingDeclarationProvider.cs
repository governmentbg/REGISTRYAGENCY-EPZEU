...
{
    /// <summary>
    /// Реализация на интерфейс IApplicationProvider за работа със "Декларация - съгласие"
    /// </summary>
    internal class AppointingDeclarationProvider : AppointingDemandDocumentsProvider<AppointingDeclaration>
    {
