...
class AuditForm extends Form {
	...
	public function __construct($name = null, $options = []) {
		...
		$this->add([
			...
			'options' => [
				'label' => 'EP_ODIT_TYPE_RESULT_L',
				'label_attributes' => [
					'class' => 'required-field'
				],
				'value_options' => [
					''	=> 'GL_CHOICE_L',
					'1' => 'EP_ODIT_RESULT_ТО_SCREEN_L' ,
					'2' => 'EP_ODIT_RESULT_FILE_L',
				],
			],
			'attributes' => [
				'id' => 'actionType',
		...
		$this->add([
			...
			'type' => \Zend\Form\Element\Select::class,
			'options' => [
				'label' => 'EP_ODIT_SEARCH_TOT_L',
				'label_attributes' => [
					'class' => 'required-field'
				],
				'value_options' => [
					''	=> 'GL_CHOICE_L',
					'1' => 'EP_ODIT_SEARCH_ТО_CURRENT_L' ,
					'2' => 'EP_ODIT_SEARCH_ТО_ARCHIVE_L',
				],
			],
			'attributes' => [
				'id' => 'searchType',
