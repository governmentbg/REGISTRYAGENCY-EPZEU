...
return [
	'config' => [
		...
		'error_log' => 'C:\Projects\EPZEU\QA\02 Logs\01 Applications\InternalPortal\\',
		'rest_service' => [
	...
	'identity_provider' => [
		...
		'redirect_uri'					=> 'https://admin.qa.epzeu.dev.local/login',
		'post_logout_redirect_uri'		=> 'https://admin.qa.epzeu.dev.local/',
		'post_logout_redirect_idle_uri'	=> 'https://admin.qa.epzeu.dev.local/idle',
	],
	'ldap' => [
