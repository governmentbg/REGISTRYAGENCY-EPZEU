...
class UserEntity {
	...
	/**
	 * Флаг, указващ дали потребителят подава заявка за специален достъп.
	 *
	 * @var string
	 */
	...
	/**
	 * Връща флаг, указващ дали потребителят подава заявка за специален достъп.
	 *
	 * @return string
	 */
	...
	/**
	 * Задава флаг, указващ дали потребителят подава заявка за специален достъп.
	 *
	 * @param string
	 */
	...
	public function setCrBulletinAcceptance($crBulletinAcceptance) {
		$this->crBulletinAcceptance = (int)$crBulletinAcceptance;
	}
	...
	public function setPrBulletinAcceptance($prBulletinAcceptance) {
		$this->prBulletinAcceptance = (int)$prBulletinAcceptance;
	}
	...
	public function setCrMessageAcceptance($crMessageAcceptance) {
		$this->crMessageAcceptance = (int)$crMessageAcceptance;
	}
	...
	public function setPrMessageAcceptance($prMessageAcceptance) {
		$this->prMessageAcceptance = (int)$prMessageAcceptance;
	}
	...
	public function setEpzeuMessageAcceptance($epzeuMessageAcceptance) {
		$this->epzeuMessageAcceptance = (int)$epzeuMessageAcceptance;
	}
