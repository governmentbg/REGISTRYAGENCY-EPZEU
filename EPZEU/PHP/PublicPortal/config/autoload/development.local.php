...
return [
	'config' => [
		...
		'error_log' => 'C:\Projects\EPZEU\Development\02 Logs\01 Applications\PublicPortal\\',
		'rest_service' => [
	...
	'identity_provider' => [
		...
		'post_logout_redirect_uri'		=> 'https://portal.dev.epzeu.dev.local/',
		'post_logout_redirect_idle_uri'	=> 'https://portal.dev.epzeu.dev.local/idle',
	],
];
