...
namespace EPZEU.ServiceLimits.Server.Manager
{
    public partial class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            var environmentName = GetHostingParametersEnvironmentName(args);
        ...
        private static string GetHostingParametersEnvironmentName(string[] args)
        {
            ConfigurationBuilder configurationBuilder = new ConfigurationBuilder();
            ...
            string ret = configuration[HostDefaults.EnvironmentKey] ?? Environments.Production;
