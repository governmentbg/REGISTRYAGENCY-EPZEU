...
namespace System.Text.Json
{
    ...
    /// може да го махнем.
    /// </summary>
    public static class EPZEUJsonSerializer
    {
        static EPZEUJsonSerializer()
        {
        ...
        public static JsonSerializerOptions GetDefaultSerializerOptionsCopy()
        {
            ...
            serializerOptions.Converters.Add(new EPZEUJsonEnumConverterFactory(JsonNamingPolicy.CamelCase));
