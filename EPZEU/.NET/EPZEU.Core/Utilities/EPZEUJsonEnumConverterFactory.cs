...
namespace EPZEU.Utilities
{
    ...
    /// TODO: TRIR-4205
    /// </summary>
    public sealed class EPZEUJsonEnumConverterFactory : JsonConverterFactory
    {
        ...
        /// </param>
        public EPZEUJsonEnumConverterFactory(JsonNamingPolicy namingPolicy = null)
        {
        ...
        public override JsonConverter CreateConverter(Type typeToConvert, JsonSerializerOptions options)
        {
            JsonConverter converter = (JsonConverter)Activator.CreateInstance(
                typeof(EPZEUJsonEnumConverter<>).MakeGenericType(typeToConvert),
