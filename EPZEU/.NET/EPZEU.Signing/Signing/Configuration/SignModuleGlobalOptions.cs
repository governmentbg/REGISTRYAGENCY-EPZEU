namespace EPZEU.Signing.Configuration
{
    public class SignModuleGlobalOptions
    {
        ...
        /// <summary>
        /// Тhumbprint на сървърен сертификат за криптиране на комуникацията между ЕПЗЕУ и BISS - локална услуга за подписване в браузер.
        /// </summary>
        public string EP_SIGN_BISS_CERT_THUMBPRINT { get; set; }

        /// <summary>
        /// Базов адрес за достъп до услугата BSecure DSSL на B-Trust.
        /// </summary>
        public string EP_SIGN_BSECURE_DSSL_API { get; set; }
        ...
        /// </summary>
        public string EP_SIGN_BTRUST_REMOTE_CLIENT_API { get; set; }

        /// <summary>
        /// Сертификат за ауторизация пред услугата за отдалечено подписване на B-Trust.
        /// </summary>
        public string EP_SIGN_BTRUST_REMOTE_CLIENT_CERT { get; set; }

        /// <summary>
        /// Идентификатор на публичната част на ТР във системата на B-Trust.
        /// </summary>
        public string EP_SIGN_BTRUST_REMOTE_RELYINGPARTY_ID { get; set; }
        ...
        /// </summary>
        public string EP_SIGN_EVROTRUST_CALLBACK_BASE_URL { get; set; }

        /// <summary>
        /// Базов адрес за достъп до услугата за отдалечено подписване на Evrotrust.
        /// </summary>
        public string EP_SIGN_EVROTRUST_CLIENT_API { get; set; }

        /// <summary>
        /// Ключ за ауторизация пред услугата за отдалечено подписване на Evrotrust.
        /// </summary>
        public string EP_SIGN_EVROTRUST_VENDOR_API_KEY { get; set; }

        /// <summary>
        /// Номер на продавача (публичната част на ТР) във системата на Evrotrust.
        /// </summary>
        public string EP_SIGN_EVROTRUST_VENDOR_NUM { get; set; }
        ...
        /// </summary>
        public string EP_SIGN_SIGNATURE_LEVEL { get; set; }
        ...
        /// </summary>
        public int? EP_SIGN_SKIP_VALIDATION_AFTER_SIGN { get; set; }
    }
}
