namespace EPZEU.Users.Models
{
    ...
    public class AuthenticationResult
    {
        ...
        /// <summary>
        /// Флаг, указващ дали сертификата с който се опитва да се автентификира, е бил подновен.
        /// </summary>
        public bool CertificateWasRenewed { get; set; }
        ...
        public bool IsSuccess => 
            User != null && !InvalidUsernamePassword && !UserLocked && !NotConfirmedAccount && !UserDeactivated && !CertificateNotEnabled && !CertificateWasRenewed;
    }
}
