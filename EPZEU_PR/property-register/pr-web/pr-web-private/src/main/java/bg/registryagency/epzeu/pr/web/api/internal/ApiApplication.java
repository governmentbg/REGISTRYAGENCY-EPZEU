package bg.registryagency.epzeu.pr.web.api.internal;
...
import bg.registryagency.epzeu.pr.web.api.internal.config.ApplicationApiProperties;
import bg.registryagency.epzeu.pr.web.api.internal.config.DefaultProfileUtil;
...
//TODO Delete all unneeded copmponents from Private Web Module now it is copy of Public Web Module but there are a lot of things that are not needed for private module
@ComponentScan
    ...
    public void initApplication() {
        ...
        if (activeProfiles.length > 1) {
            log.error("You have misconfigured your application! It should run " +
                "with one active profile (dev, dev-vm, qa, staging, prod).");
