...
export class AttachmentInfo extends BaseDataModel {
  ...
  @observable private _attachmentInfoType: AttachmentInfoTypeEnum = null;
  ...
  public get attachmentInfoType(): AttachmentInfoTypeEnum {
    return this._attachmentInfoType;
  }

  @TypeSystem.propertyDecorator(AttachmentInfoTypeEnum ? AttachmentInfoTypeEnum : moduleContext.moduleName + '.' + 'AttachmentInfoTypeEnum')
  public set attachmentInfoType(value: AttachmentInfoTypeEnum) {
    this._attachmentInfoType = value;
  }
}
