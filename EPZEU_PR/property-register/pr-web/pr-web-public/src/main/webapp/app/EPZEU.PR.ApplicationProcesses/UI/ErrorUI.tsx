      ...
      <div className="page-wrapper">
        <div className="section-wrapper">
          ...
          <div className="alert alert-danger" role="alert">
            {this.props.processContext.status == ProcessStatuses.ErrorInSignature && ((this.getResource("GL_UNABLE_SIGNING_APPLICATION_E"))
              + (!ObjectHelper.isStringNullOrEmpty(this.props.processContext.applicationProcess.errorMessage) ? ": " + this.props.processContext.applicationProcess.errorMessage : ""))}
            {this.props.processContext.status == ProcessStatuses.ErrorInAccepting && (this.getResource("GL_UNABLE_ACCEPT_APPLICATION_E")
              + (!ObjectHelper.isStringNullOrEmpty(this.props.processContext.applicationProcess.errorMessage) ? ": " + this.props.processContext.applicationProcess.errorMessage : ""))}
          </div>
