...
export class ApplicationForCertificateForPeriodForPropertyProvider implements IApplicationProvider {
  ...
  get appFormType(): ApplicationFormTypes {
      return ApplicationFormTypes.ApplicationForCertificateForPeriodForProperty;
  }
}
