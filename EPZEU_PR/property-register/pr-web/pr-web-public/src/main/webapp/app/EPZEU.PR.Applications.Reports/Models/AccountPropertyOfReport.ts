...
@TypeSystem.typeDecorator('AccountPropertyOfReport', moduleContext.moduleName)
export class AccountPropertyOfReport extends BaseDataModel {

  @observable private _accountPropertyId: string = null;
  ...
  public get accountPropertyId(): string {
    return this._accountPropertyId;
  }

  @TypeSystem.propertyDecorator('string')
  public set accountPropertyId(value: string) {
    this._accountPropertyId = value;
  }
  ...
  public toString(): string {
    ...
    if (this.propertyType && this.propertyType.name) {
      ...
      toString = "<p class=\"field-text\"><span class =\"field-title field-title--preview\">" + resourceManager.getResourceByKey('PR_APP_PROPERTY_L') + "</span></p><p class=\"field-text\">"
    }
