...
@TypeSystem.typeDecorator('WayOfProvisionBaseData', moduleContext.moduleName)
export class WayOfProvisionBaseData extends BaseDataModel {
  ...
  @observable private _selectedOnCornerDeliveryMethod: boolean = true;
