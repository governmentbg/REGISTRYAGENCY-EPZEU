...
/**
 * Provider за осигуряване на заявление от тип Заявление за издаване на удостоверение за период за имот от Имотен регистър.
 */
@Component
public class ApplicationForCertificateForPeriodForPropertyProvider extends BaseApplicationForCertificateForPeriodProvider {

    private final ApplicationTypeReauNomenclatureCache applicationTypeNomenclatureCache;

    public ApplicationForCertificateForPeriodForPropertyProvider(UserWebClient userWebClient, ApplicationWebClient applicationWebClient,
    ...
    /**
     * Създава нова инстанция на заявление от тип Заявление за издаване на удостоверение за период за лице от Имотен регистър.
     *
     * @return Заявление за издаване на удостоверение за период за имот от Имотен регистър.
     */
    @Override
    public ApplicationForCertificateForPeriodDto buildNewInstanceOfApplicationDto() {
        ...
        List<ServicePriceDto> prices = applicationTypeNomenclatureCache.get(ApplicationType.APPLICATION_CERTIFICATE_PERIOD_FOR_PROPERTY.getCode()).getPrices();
