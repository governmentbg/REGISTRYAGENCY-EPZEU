...
public class ApplicationDocumentCreateSP extends StoredProcedure {
    private static final String SP_NAME = SchemaEnum.AP + ".f_application_documents_create";
    private static final String OUTPUT_ID = "p_application_document_id";

    public ApplicationDocumentCreateSP(DataSource dataSource) {
    ...
    public Long execute(ApplicationDocument applicationDocument) {
