...
/**
 * Контейнер на данни за имот от справка чрез отдалечен достъп.
 */
@Getter
@Setter
@NoArgsConstructor
@Schema(name = "PropertyOfReportDto", description = "Контейнер на данни за имот от справка чрез отдалечен достъп.")
public class PropertyOfReportDto {
